...
function _0xb1b4() {
  const _0x113865 = [
    'quoted',
    'No\x20valid\x20JSON\x20response\x20from\x20program\x20',
    'reply',
    '3jHchyf',
    'json',
    'chat',
    'result',
    'Please\x20provide\x20some\x20report',
    '10jgaojq',
    '1224668cTLgnn',
    '721575eyMVOi',
    '1385901iFYTlu',
    ...
    '21RIoHpz',
    'bing',
    'Your report (feedback) has been sent!',
    'help',
    '609992HifjSS',
    '1202496XfQOBE',
    'LBSIU',
...
handler[_0x19dd6a(0x120)] = ['BOT-SUPPORT']
handler[_0x19dd6a(0x113)] = ['feedback','report']
handler.group = true
