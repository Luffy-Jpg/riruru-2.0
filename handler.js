      ...
      if (chat.welcome) {
        ...
        for (let user of participants) {
          ...
          try {
            ...
            pp = 'https://i.ytimg.com/vi_webp/fSMiH4NOga0/maxresdefault.webp' // Assign default image URL
            ppgp = 'https://i.ytimg.com/vi_webp/fSMiH4NOga0/maxresdefault.webp' // Assign default image URL
          } finally {
            ...
            let welcomeApiUrl = `https://welcome.guruapi.tech/welcome-image?username=${encodeURIComponent(
              ...
              'https://i.ytimg.com/vi_webp/fSMiH4NOga0/maxresdefault.webp'
            )}`
...
export async function deleteUpdate(message) {
  try {
    ...
    this.copyNForward().catch(e => console.log(e, msg))
  } catch (e) {
    console.error(e)
  }
}
...
global.dfail = (type, m, conn) => {
  ...
  const msg = {
    ...
    nsfw: `*NSFW Query*\n
    NSFW is not active. Please contact the Group admin to enable this feature!`,
